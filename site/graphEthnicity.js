...
function graphEthnicity(domElement, fileName)
{
  ...
  //ethGraph = d3.select(domElement).append("ethGraph")
  ethGraph = d3.select(domElement).append("svg")
